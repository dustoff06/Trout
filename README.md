...
├── README.md
├── data/
│   └── RainbowTrout_Growth_Data.xlsx     # USGS source data (fish + environmental)
├── final06072025.ipynb                   # Main analysis notebook
├── fish_model_data.csv                   # Preprocessed dataset (generated by notebook)
